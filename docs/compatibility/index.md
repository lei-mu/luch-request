---
title: 平台兼容性
description: v4 首个稳定版本的构建边界、计划支持范围和发布验证要求
---

# 平台兼容性

本文描述 v4 首个稳定版本的**计划支持范围**。兼容性结论以真实平台验证为准，
理论可执行不等于正式支持。

::: warning Alpha 阶段
当前尚未完成稳定版要求的全部真机与模拟器 smoke test。未验证的平台不能视为已承诺支持。
:::
...
在这些验证完成前，文档会持续使用“计划支持”，不会写成“已完全支持”。
